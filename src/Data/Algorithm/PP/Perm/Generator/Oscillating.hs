...
{- | 'oscillatingIncreasing' @n@ returns the oscillating increasing permutation of length @n@.
...
{- | 'oscillatingIncreasings' returns the infinite list of all oscillating increasing permutations.

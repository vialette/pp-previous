...
where
  ...
  rank' :: (Array.Ix e, Num e) => e -> Array.Array e e -> Array.Array e e -> (e, Array.Array e e, Array.Array e e)
  rank' n a b = (s, a', b')
    where
      s  = a ! (n-1)
      a' = swap (n-1) (b ! (n-1)) a
  ...
  -- |'unrank1' 'k' 'n'
  --
  -- >>> let n = 3 in [(i, unrank1 3 i) | i <- [0..product [1..n]-1]]
  -- [(0,[2,3,1]),(1,[3,1,2]),(2,[2,1,3]),(3,[3,2,1]),(4,[1,3,2]),(5,[1,2,3])]
  -- >>> let n = 3 in and [i == rank2 (unrank2 n i) | i <- [0..product [1..n]-1]]
  -- True
  unrank1 :: Int -> Int -> PP.Perm.Perm
  unrank1 n r = PP.Perm.mkPerm . unrank1' n r $ mkArray [0..n-1]

  unrank1' :: (Integral i, Array.Ix i) => i -> i -> Array.Array i e -> [e]
  unrank1' n r a
  ...
  -- >>>  let n = 3 in and [i == rank1 (unrank1 n i) | i <- [0..product [1..n]-1]]
  -- True
  unrank2 :: Int -> Int -> PP.Perm.Perm
  unrank2 n r = PP.Perm.mkPerm . unrank2' n r $ mkArray [0..n-1]

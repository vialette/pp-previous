...
prefixes =  L.tail . L.inits . getPoints
...
suffixes = L.init . L.tails . getPoints
...
kFactors k = PP.Utils.List.chunk k . getPoints
...
factors p = L.concat [kFactors k p |  k <- [1..len p]]

...
{- | 'shuffle3' @p@ @q@ @r@ returns all distinct permutations that can be be obtained by
shuffling permutation @p@, @q@ and @r@.
-}
shuffle3 :: PP.Perm.Perm -> PP.Perm.Perm -> PP.Perm.Perm -> [PP.Perm.Perm]
shuffle3 p q r = shuffle [p, q, r]

{- | 'shuffle4' @p@ @q@ @r@ @s@ returns all distinct permutations that can be be obtained by
...
{- | 'shuffle' @ps@ returns all distinct permutations that can be be obtained by
